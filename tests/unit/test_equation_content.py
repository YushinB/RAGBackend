...
class TestEquationContentInitialization:
    ...
    def test_display_mode_equation(self):
        ...
        equation = EquationContent(
            latex_code=r"\int_0^\infty e^{-x} dx = 1",
            is_inline=False
        )
    ...
    def test_equation_with_context_before(self):
        ...
        equation = EquationContent(
            latex_code=r"F = ma",
            context_before="Newton's second law states that"
        )
    ...
    def test_equation_with_context_after(self):
        ...
        equation = EquationContent(
            latex_code=r"E = mc^2",
            context_after="is Einstein's famous equation"
        )
    ...
    def test_equation_with_both_contexts(self):
        ...
        assert equation.surrounding_context == "The value of pi ... is approximately 3.14159"
    ...
    def test_equation_with_explicit_surrounding_context(self):
        ...
        assert equation.surrounding_context == "Quadratic formula for solving ax²+bx+c=0"
    ...
    def test_equation_with_position(self):
        ...
        equation = EquationContent(
            latex_code=r"\sum_{i=1}^n i = \frac{n(n+1)}{2}",
            position=position
        )
...
class TestEquationContentMethods:
    ...
    def test_get_full_context_with_only_after(self):
        ...
        equation = EquationContent(
            latex_code=r"a^2 + b^2 = c^2",
            context_after="is the Pythagorean theorem"
        )
...
class TestEquationContentEdgeCases:
    ...
    def test_equation_with_unicode_latex(self):
        ...
        equation = EquationContent(
            latex_code=r"\alpha + \beta = \gamma",
            rendered_text="α + β = γ"
        )

        assert equation.latex_code == r"\alpha + \beta = \gamma"
        assert equation.rendered_text == "α + β = γ"
