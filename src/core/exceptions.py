...
class ProcessingException(RAGBackendException):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        details = {"file_path": file_path, "processor_type": processor_type, **kwargs}
...
class UnsupportedFormatException(ProcessingException):
    ...
    def __init__(self, file_path: str, file_type: str) -> None:
        ...
        super().__init__(message, file_path=file_path, error_code="UNSUPPORTED_FORMAT")
...
class FileNotFoundError(ProcessingException):
    ...
    def __init__(self, file_path: str) -> None:
        ...
        super().__init__(message, file_path=file_path, error_code="FILE_NOT_FOUND")
...
class CorruptedFileError(ProcessingException):
    ...
    def __init__(self, file_path: str, reason: str) -> None:
        ...
        super().__init__(
            message, file_path=file_path, reason=reason, error_code="CORRUPTED_FILE"
        )
...
class EmbeddingException(RAGBackendException):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        details = {"model_name": model_name, "text_length": text_length, **kwargs}
...
class VectorStoreException(RAGBackendException):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        details = {"operation": operation, "table_name": table_name, **kwargs}
...
class QueryProcessingException(RAGBackendException):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        details = {"query": query, "stage": stage, **kwargs}
...
class LLMException(RAGBackendException):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        details = {"model_name": model_name, "endpoint": endpoint, **kwargs}
